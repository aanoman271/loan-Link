...
const ManagerProfile = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-app-text">Profile Settings</h2>
        <p className="text-app-text-muted mt-1">Manage your account details and security preferences.</p>
      </div>
          ...
          <div className="relative -mt-12 flex flex-col md:flex-row items-end gap-6 mb-8">
            ...
            <div className="flex-1 pb-2">
              ...
              <div className="flex items-center gap-3 mt-1">
                <p className="text-app-text-muted font-medium">{user?.email}</p>
            ...
            <div className="flex gap-3">
              ...
              <Link to="/dashboard/profile" className="btn btn-primary rounded-xl px-8 shadow-lg shadow-primary/20">Edit Profile</Link>
            </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-8 border-t border-app-border-subtle">
            <div className="space-y-6">
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-app-surface-hover/50">
